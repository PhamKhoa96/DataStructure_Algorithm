...
void insert(int key,int data){
   ...
   while(hashArray[hashIndex] != NULL && hashArray[hashIndex]->key != -1){          //-1 là vùng tại đó có giá trị nhưng đã bị xóa nên ta có thể insert giá trị mới vào
      //di chuyen toi o tiep theo                                                   //NULL là vùng tại đó chưa có giá trị ngay từ khi khởi tạo đến lúc insert
      ++hashIndex;
